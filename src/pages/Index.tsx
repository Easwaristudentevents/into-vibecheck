  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-blue-100 to-blue-200 text-black font-sans relative overflow-x-hidden">
      ...
      <section id="home" className={`min-h-screen flex items-center justify-center px-4 pt-20 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
        <TiltedCard className="max-w-5xl mx-auto">
      ...
      <section id="about" className={`py-20 px-4 transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
        <TiltedCard className="max-w-6xl mx-auto">
          <div className="glass-card p-12 text-center shadow-xl">
        ...
        <div className="max-w-6xl mx-auto">
          <TiltedCard className="mb-16">
            <div className="glass-card p-8 text-center shadow-xl">
              <h2 className="text-4xl md:text-5xl font-black uppercase tracking-wide text-black">
                Why Vibe-Check?
              </h2>
            </div>
          </TiltedCard>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <TiltedCard tiltMaxAngle={10} scale={1.03}>
            ...
            <div className="space-y-8 mb-12">
              <div>
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  ...
                  <Button 
                    onClick={() => window.open('https://www.instagram.com/easwari_student_events/', '_blank')}
                    className="bg-white/20 backdrop-blur-sm text-black border border-white/30 px-8 py-3 text-sm font-bold tracking-widest uppercase rounded-2xl hover:bg-black hover:text-white transition-all duration-300 shadow-lg flex-1 sm:flex-none"
                  >
        ...
        <TiltedCard className="max-w-4xl mx-auto">
          <div className="glass-card p-12 text-center shadow-xl">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <TiltedCard tiltMaxAngle={8} scale={1.02}>
